...
export default async function AdminPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      subtext:
        "Scholarship applications currently waiting on admin action.",
    ...
    },
    {
      ...
      value: adminRank,
      subtext:
        "Your current administrative authority inside the portal.",
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[1.45fr_0.95fr]">
        <div className="rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.22),transparent_38%),radial-gradient(circle_at_top_right,rgba(239,68,68,0.14),transparent_32%),rgba(10,14,25,0.9)] p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_24px_80px_rgba(0,0,0,0.45)] sm:p-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
              ...
              actions forward, and keep the portal aligned with the standard the
              brotherhood is building toward.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="rounded-[28px] border border-red-400/20 bg-[radial-gradient(circle_at_top_right,rgba(239,68,68,0.18),transparent_38%),rgba(16,18,28,0.92)] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
            ...
            <a
              href="/admin/scholarship"
              className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/8 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/12"
            >
          ...
          <div className="rounded-[28px] border border-white/10 bg-[rgba(15,18,28,0.92)] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Rank: {adminRank} • Role: {profile.role}
            </p>

            <div className="mt-5 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm leading-7 text-slate-300">
              A strong admin portal should feel like a control room — not just a
              list of links. This dashboard is your starting point for member
              oversight, publishing, and platform discipline.
            </div>
          </div>
        </div>
      </section>
