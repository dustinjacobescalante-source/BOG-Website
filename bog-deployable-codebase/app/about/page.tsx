          ...
          <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
            <div
              ...
              style={{
                ...
                background: `
                  radial-gradient(ellipse at 38% 58%, rgba(220, 38, 38, 0.58), transparent 16%),
                  radial-gradient(ellipse at 62% 58%, rgba(220, 38, 38, 0.58), transparent 16%)
                `,
                filter: "blur(4px)",
                opacity: 0.9,
              }}
