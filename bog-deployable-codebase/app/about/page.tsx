    ...
    <main className="bg-black text-white">
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-black">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_18%,rgba(255,255,255,0.10),transparent_26%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(255,255,255,0.04),transparent_40%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.08)_0%,rgba(0,0,0,0.20)_22%,rgba(0,0,0,0.48)_58%,rgba(0,0,0,0.82)_100%)]" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-28 sm:px-6 sm:pb-24 sm:pt-32 lg:px-8 lg:pb-28 lg:pt-36">
          <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-14">
            <Reveal className="max-w-4xl">
              ...
              <h1 className="mt-6 text-4xl font-black tracking-[-0.045em] text-white sm:text-5xl md:text-6xl lg:text-7xl">
                <span className="block leading-[1.02]">Built on Discipline.</span>
                <span className="block leading-[1.02]">Forged Through Brotherhood.</span>
              ...
              <div className="mt-6 h-px w-28 bg-gradient-to-r from-red-500 via-red-400/70 to-transparent" />

              <p className="mt-7 max-w-2xl text-[15px] leading-8 text-zinc-300 sm:text-base lg:text-lg">
