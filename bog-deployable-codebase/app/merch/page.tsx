...
export default async function Page() {
  ...
  return (
    <Section
      ...
      description="Now that you are a member, are you ready to wear the brand?"
    >
            ...
            <div className="relative overflow-hidden p-6 sm:p-8 lg:p-10">
              ...
              <div className="relative">
                ...
                <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                  Brotherhood merch is for members.
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-3">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-300">
                      Submit the form and choose the product. We got you from there.
                    </p>
                  </div>
            ...
            <div className="border-t border-white/10 bg-[linear-gradient(180deg,rgba(15,18,28,0.96),rgba(9,11,18,0.98))] p-6 sm:p-8 xl:border-l xl:border-t-0">
              ...
              <div className="mt-5 rounded-[24px] border border-red-400/20 bg-[radial-gradient(circle_at_top_right,rgba(239,68,68,0.16),transparent_38%),rgba(16,18,28,0.92)] p-5">
                <div className="text-[10px] font-semibold uppercase tracking-[0.24em] text-red-200">
                  YOU MUST BE A MEMBER TO WEAR OUR MERCH  
                </div>
                <h3 className="mt-3 text-2xl font-black text-white">
                  Represent BOG
                </h3>
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  Memebers who wear our merch represent Buffalo Dogs and should carry themselves in a professional manner at all times
                </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">
                  Make sure your details are accurate before
              ...
              <div className="grid gap-4">
                ...
                <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    Brotherhood gear is for members only. Order what you need and and represent the standard well.
                  </p>
                </div>
              </div>
            </div>
