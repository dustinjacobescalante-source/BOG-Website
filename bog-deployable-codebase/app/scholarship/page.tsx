...
const essayPrompts = [
  "Describe a time you had to take ownership of a difficult situation. What did you learn?",
  "What does leadership mean when no one is watching?",
  "Where have you grown most through adversity?",
];
...
export default function Page() {
  return (
    <Section
      ...
      description="If you think you have what it takes, apply here for our scholarship."
    >
          ...
          <div className="grid gap-0 xl:grid-cols-[1.15fr_0.85fr]">
            <div className="relative overflow-hidden p-6 sm:p-8 lg:p-10">
              ...
              <div className="relative">
                ...
                <div className="mt-8 rounded-[24px] border border-red-400/20 bg-[radial-gradient(circle_at_top_right,rgba(239,68,68,0.14),transparent_38%),rgba(16,18,28,0.72)] p-5">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-300">
                        Applicants may download and print the official scholarship
                        application packet before submitting.
                      </p>
                    </div>

                    <Link
                      href="/docs/iron-sharpens-iron-scholarship-application.pdf"
                      target="_blank"
                      className="inline-flex items-center justify-center gap-2 rounded-2xl border border-red-400/30 bg-red-500/15 px-5 py-3 text-sm font-semibold text-white transition hover:border-red-300/40 hover:bg-red-500/20"
                    >
